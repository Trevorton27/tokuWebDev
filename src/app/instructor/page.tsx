          ...
          <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
            ...
            <div className="space-y-3">
              {reviewQueue.map((item) => (
                <div key={item.id} className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-lg p-4 border border-orange-200">
                  <div className="flex items-start justify-between mb-2">
                    <div>
                      <span className="text-xs font-semibold text-orange-600 uppercase">{item.type}</span>
                ...
                <div key={q.id} className="bg-yellow-50 rounded-lg p-3 border border-yellow-200">
                  <div className="flex items-start justify-between mb-1">
                    <span className={`text-xs px-2 py-0.5 rounded ${
                      q.status === 'Unanswered' ? 'bg-red-100 text-red-700' : 'bg-blue-100 text-blue-700'
                    }`}>
                      {q.status}
                    </span>
                  </div>
