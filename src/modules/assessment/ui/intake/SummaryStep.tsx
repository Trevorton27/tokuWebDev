    ...
    return (
      <div className="p-6">
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 text-center">
          <p className="text-red-700">{error || 'Unable to load summary'}</p>
          <button
  ...
  return (
    <div className="p-6">
      <div className="mb-8 text-center">
        ...
        <p className="text-gray-600 mt-1">Here's your personalized skill profile</p>
      </div>
          ...
          {summary.skillProfile?.dimensions?.map((dim) => (
            <div key={dim.dimension} className="bg-white border border-gray-200 rounded-lg p-4">
              ...
              <div className="flex justify-between mt-1 text-xs text-gray-500">
                <span>{Math.round(dim.mastery * 100)}% mastery</span>
      ...
      <div className="bg-gradient-to-r from-indigo-500 to-purple-600 rounded-xl p-6 text-white text-center">
        ...
        <p className="text-indigo-100 mb-4">
          {generatingRoadmap
            ...
            : roadmapGenerated
            ? "We've created a personalized learning roadmap based on your skills and goals."
