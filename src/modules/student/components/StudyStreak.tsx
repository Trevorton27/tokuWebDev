...
export default function StudyStreak() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
      <h2 className="text-xl font-bold text-gray-900 mb-4">{t('student.yourProgress')}</h2>
      ...
      <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-lg p-4 border border-orange-100 mb-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="text-2xl font-bold text-gray-900">{streak} {t('student.days')}</div>
              <div className="text-sm text-gray-600">{t('student.studyStreak')}</div>
            </div>
          </div>
          <div className="text-right">
            <div className="text-xs text-orange-600 font-semibold uppercase">{t('student.keepItUp')}</div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-4">
        <div className="bg-gradient-to-br from-indigo-50 to-blue-50 rounded-lg p-4 border border-indigo-100">
          ...
          <div className="text-2xl font-bold text-gray-900">{challengesThisWeek}</div>
          <div className="text-xs text-gray-600">{t('student.challengesCompleted')}</div>
        </div>
        ...
        <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-lg p-4 border border-green-100">
          ...
          <div className="text-2xl font-bold text-gray-900">{hoursThisWeek}h</div>
          <div className="text-xs text-gray-600">{t('student.hoursThisWeek')}</div>
        </div>
      </div>
      ...
      <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
        <div className="flex items-center justify-between mb-2">
          <span className="text-sm font-semibold text-gray-700">{t('student.weeklyGoal')}</span>
      ...
      <div className="mt-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-lg p-3 border border-indigo-100">
        <p className="text-xs text-indigo-900 font-medium text-center">
          {streak >= 7
