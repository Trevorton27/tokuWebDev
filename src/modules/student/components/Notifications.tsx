    ...
    <div className="bg-white rounded-xl shadow-md p-6 border border-gray-100">
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-2">
          <h2 className="text-xl font-bold text-gray-900">{t('student.notifications')}</h2>
          {unreadCount > 0 && (
      ...
      {notifications.length > 0 ? (
              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between mb-1">
                    ...
                    {!notification.read && (
                      <div className="w-2 h-2 bg-indigo-500 rounded-full mt-1.5 ml-2"></div>
                    )}
                  </div>
        ...
        <div className="text-center py-8">
          ...
          <p className="text-sm text-gray-500">{t('student.noNotifications')}</p>
        </div>
      )}
      ...
      {unreadCount > 0 && (
        <div className="mt-4 pt-4 border-t border-gray-200">
          <button className="w-full text-sm text-indigo-600 hover:text-indigo-700 font-medium text-center">
