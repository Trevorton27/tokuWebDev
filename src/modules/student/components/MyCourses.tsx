    ...
    <div className="bg-white dark:bg-dark-card rounded-xl shadow-md p-6 border border-gray-100 dark:border-dark-border">
      <div className="flex items-center justify-between mb-6">
        ...
        <Link
          ...
          className="text-indigo-600 dark:text-purple-400 hover:text-indigo-700 dark:hover:text-purple-300 font-medium text-sm flex items-center"
        >
      ...
      {loading ? (
        <div className="flex justify-center items-center py-8">
          <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-indigo-600 dark:border-purple-500"></div>
        </div>
        ...
        <div className="text-center py-8">
          ...
          <Link
            href="/student/courses"
            className="inline-flex items-center px-4 py-2 bg-indigo-600 dark:bg-purple-600 text-white rounded-lg font-semibold hover:bg-indigo-700 dark:hover:bg-purple-700 transition"
          >
        ...
        <div className="space-y-4">
          {enrollments.slice(0, 3).map((enrollment) => (
            <Link
              ...
              className="block p-4 rounded-lg border border-gray-200 dark:border-dark-border hover:border-indigo-300 dark:hover:border-purple-600 hover:shadow-md transition"
            >
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 mb-2">
                <div
                  className="bg-indigo-600 dark:bg-purple-600 h-2 rounded-full transition-all"
          ...
          {enrollments.length > 3 && (
            <Link
              ...
              className="block text-center text-indigo-600 dark:text-purple-400 hover:text-indigo-700 dark:hover:text-purple-300 font-medium text-sm pt-2"
            >
