...
function SettingsContent() {
  ...
  useEffect(() => {
    ...
    if (success === 'google_calendar_connected') {
      ...
      router.replace('/instructor/calendar-config');
    } else if (error) {
  ...
  const userName = user?.firstName || user?.fullName || user?.username || 'Instructor';

  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50 to-purple-50 dark:from-dark-bg dark:via-dark-surface dark:to-dark-bg">
      {/* Header Section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 mt-1">
              Connect your Google Calendar to sync events and receive notifications
            </p>
          </div>
        </div>
      </div>
